 ...
 *         &lt;element name="misraCategoryList" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class MergedDefectFilterSpecDataObj {
    ...
    /**
     * Gets the value of the misraCategoryList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the misraCategoryList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMisraCategoryList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<String> getMisraCategoryList() {
        if (misraCategoryList == null) {
            misraCategoryList = new ArrayList<String>();
        }
